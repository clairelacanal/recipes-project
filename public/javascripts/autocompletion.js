let ingredients = ['gouda','egg','mozzarella cheese', 'parmesan cheese', 'gruyere chesse','cream', 'milk', 'goat cheese', 'queso fresco', 'cinnamon', 'fresh basil leaves', 'thyme sprigs', 'sesame oil', 'chicken', 'turkey breast', 'chicken breast', 'teriaky sauce', 'bbq sauce', 'apple', 'avocado', 'bananas', 'cranberries', 'dates', 'grapefruit', 'grape', 'lemon', 'lemon juice', 'lime', 'lime juice', 'olive', 'orange', 'pineapple', 'strawberries', 'watermelon', 'ham', 'pork loin roast', 'bacon', 'green beans', 'fresh corn', 'cucumber', 'garlic', 'lettuce', 'portobello mushrooms', 'button mushrooms', 'onions', 'peas', 'potatoes', 'zucchini', 'tomatoes', 'almonds', 'coconut', 'nuts', 'wine', 'white wine', 'tofu', 'bread', 'white bread', 'pita breads', 'milk chocolate', 'white chocolate', 'dark chocolate','brown rice', 'rice', 'pesto sauce', 'roast beef', 'plain yogurt', 'herbs', 'chocolat chips', 'fresh herbs', 'spaghetti', 'pasta', 'carrots', 'chickpeas', 'chocolate', 'fish'];
